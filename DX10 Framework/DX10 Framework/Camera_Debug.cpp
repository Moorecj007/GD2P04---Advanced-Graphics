...
bool CCamera_Debug::Initialise(CDX10Renderer* _pRenderer)
{
...
void CCamera_Debug::SetView(D3DXVECTOR3& _vecPos, D3DXVECTOR3& _vecLookAt, D3DXVECTOR3& _vecUp)
{
...
void CCamera_Debug::Process()
{
	...
	m_pRenderer->SetViewMatrix(m_vecPosition, m_vecTarget, vecUp);
}

void CCamera_Debug::Pitch(float _fDeg)
{
...
void CCamera_Debug::Yaw(float _fDeg)
{
...
void CCamera_Debug::Move(float _fDistance)
{
