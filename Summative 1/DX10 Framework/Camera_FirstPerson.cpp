...
CCamera_FirstPerson::CCamera_FirstPerson()
{
}
...
bool CCamera_FirstPerson::Initialise(CDX10Renderer* _pRenderer, HINSTANCE _hInstance, HWND _hWnd)
{
...
void CCamera_FirstPerson::Process(float _dt)
{
	// Get mouse input
...
void CCamera_FirstPerson::MoveForwards(float _dir)
{
	if (_dir > 0)
	{
...
void CCamera_FirstPerson::Strafe(float _dir)
{
	if (_dir > 0)
	{
...
void CCamera_FirstPerson::Fly(float _dir)
{
	if (_dir > 0)
	{
...
void CCamera_FirstPerson::RotateYaw(float _dir)
{
	if (_dir > 0)
	{
...
void CCamera_FirstPerson::RotatePitch(float _dir)
{
	if (_dir > 0)
	{
